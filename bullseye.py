...
#-------------------------------------------------------------------------------
    def on(self):
        ...
        cmd_util.run_cmd_oneline(self.ostream, cmd, None, env, show_env)
    ...
    def apply_region(self, region_file):
        ...
        cmd_util.run_cmd_oneline(self.ostream, cmd, None, None, show_env)
    ...
    def generate_csv(self):
        ...
        self.ostream.write("Create bullseye result csv file: %s\n" % (self.csv_file))
